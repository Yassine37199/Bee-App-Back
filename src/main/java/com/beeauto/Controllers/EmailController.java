...
public class EmailController{
    ...
    public ResponseEntity<EmailRequest> send(@RequestBody EmailRequest emailRequest) throws AddressException, MessagingException, IOException {
        ...
        Session session = Session.getInstance(props, new javax.mail.Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(emailRequest.getFrom() , emailRequest.getFromPassword());
            }
        });

        Message msg = new MimeMessage(session);
        msg.setFrom(new InternetAddress(emailRequest.getFrom() , false));
        msg.setRecipients(Message.RecipientType.TO , InternetAddress.parse(emailRequest.getTo()));
    ...
    private String buildEmail(String content) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Email BEE TEST</span>\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "              </a>\n" +
